import { CheckCircle, FileText, BarChart3, Settings, Scale, Clock } from 'lucide-react';
...
export function VerifierSidebar({ activeView, onNavigate }: VerifierSidebarProps) {
  const menuItems = [
    { id: 'queue', label: 'Verification Queue', icon: Clock },
    { id: 'verify', label: 'Active Verification', icon: CheckCircle },
