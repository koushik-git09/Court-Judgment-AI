import { LayoutDashboard, Upload, CheckCircle, Building2, BarChart3, Settings, Scale } from 'lucide-react';
...
export function Sidebar({ activeView, onNavigate }: SidebarProps) {
  const menuItems = [
    ...
    { id: 'upload', label: 'Upload Case', icon: Upload },
    { id: 'verifier', label: 'Verification Queue', icon: CheckCircle },
    { id: 'department', label: 'Department Actions', icon: Building2 },
    ...
    <aside className="w-64 bg-gradient-to-b from-[#8B0000] to-[#6B0000] text-white flex flex-col h-full">
      <div className="p-6 border-b border-white/10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-sm opacity-90">Karnataka Govt</div>
